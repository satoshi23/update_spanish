...
function c58330108.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		local b3=Duel.IsExistingMatchingCard(c58330108.rmfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,LOCATION_ONFIELD+LOCATION_GRAVE,1,c)
	...
	if gc==1 then
		...
		local g=Duel.GetMatchingGroup(c58330108.rmfilter,tp,loc,loc,c)
